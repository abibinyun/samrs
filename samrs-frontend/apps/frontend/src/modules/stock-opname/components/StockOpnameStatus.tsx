...
export const stockOpnameStatus = (status: StockOpnameStatus) => {
  switch (status) {
    case "draft": return { label: "Draft", className: "bg-blue-100 text-blue-700 border-blue-200" };
...
export const stockOpnameCondition = (condition: StockOpnameCondition) => {
  switch (condition) {
    case "match": return { label: "Sesuai", className: "bg-green-100 text-green-700 border-green-200" };
    case "missing": return { label: "Hilang", className: "bg-red-100 text-red-700 border-red-200" };
    case "damaged": return { label: "Rusak", className: "bg-orange-100 text-orange-700 border-orange-200" };

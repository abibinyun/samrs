...
export const mutationRoutes = [
  createRoute({ 
    ...
    beforeLoad: () => {
      requirePermission(SCOPES.ASSET_MUTATION.READ);
    },
    component: lazyRouteComponent(() =>
      import("./pages/MutationListPage")
    ),
  ...
  createRoute({ 
    ...
    beforeLoad: () => {
      requirePermission(SCOPES.ASSET_MUTATION.CREATE);
    },
    component: lazyRouteComponent(() =>
      import("./pages/MutationCreatePage")
    ),
